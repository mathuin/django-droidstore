# http://djangosnippets.org/snippets/1907/
...
class EncryptEmail(template.Node):
    ...
    def render(self, context):
        ...
        cipher_text = ''
        eid = 'e' + str(random.randrange(1,999999999))
        ...
        script += 'document.getElementById("'+eid+'").innerHTML="<a href=\\"mailto:"+d+"\\">"+d+"</a>"'
        
        
        script = "eval(\""+ script.replace("\\","\\\\").replace('"','\\"') + "\")"
        script = '<script type="text/javascript">/*<![CDATA[*/'+script+'/*]]>*/</script>'
        
        return '<span id="'+ eid + '">[javascript protected email address]</span>'+ script
